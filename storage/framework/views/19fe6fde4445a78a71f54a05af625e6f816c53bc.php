                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <!-- Agregando el menu
                            ...
                            <li><a href="<?php echo e(route('authorized-clients')); ?>">Authorized Clients</a></li>
                             -->
                            <li><a href="<?php echo e(route('personal-tokens')); ?>">Cotizaciones</a></li>
                            <li><a href="<?php echo e(route('personal-clients')); ?>">Proveeedores</a></li>
                            <li><a href="<?php echo e(route('authorized-clients')); ?>">Productos</a></li>
                        <?php endif; ?>
                    </ul>
